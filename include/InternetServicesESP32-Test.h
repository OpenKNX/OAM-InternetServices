...
// Temperatur Eingang
#define KoSHC_TemperatureInput                    (knx.getGroupObject(SHC_KoTemperatureInput))
// Temperaturprognose Eingang
#define KoSHC_TemperatureForecastInput            (knx.getGroupObject(SHC_KoTemperatureForecastInput))
// Helligkeit Eingang
...
#define SHC_ChannelDeactivated                   1      // 1 Bit, Bit 7
#define     SHC_ChannelDeactivatedMask 0x80
#define     SHC_ChannelDeactivatedShift 7
#define SHC_ChannelIgnoreFirstManualCommandIfShadingActiv  1      // 1 Bit, Bit 6
#define     SHC_ChannelIgnoreFirstManualCommandIfShadingActivMask 0x40
#define     SHC_ChannelIgnoreFirstManualCommandIfShadingActivShift 6
#define SHC_ChannelModeNight                     1      // 1 Bit, Bit 5
#define     SHC_ChannelModeNightMask 0x20
#define     SHC_ChannelModeNightShift 5
...
#define SHC_ChannelModeNightFromTime             4      // 16_t
#define SHC_ChannelModeNightSunSet               6      // 4 Bits, Bit 7-4
#define     SHC_ChannelModeNightSunSetMask 0xF0
#define     SHC_ChannelModeNightSunSetShift 4
#define SHC_ChannelModeNightSunSetElevationOffset  7      // uint8_t
#define SHC_ChannelNightModeEndBehavior          8      // 4 Bits, Bit 7-4
#define     SHC_ChannelNightModeEndBehaviorMask 0xF0
#define     SHC_ChannelNightModeEndBehaviorShift 4
#define SHC_ChannelModeNightToTime               9      // 16_t
#define SHC_ChannelModeNightSunRise             11      // 4 Bits, Bit 7-4
#define     SHC_ChannelModeNightSunRiseMask 0xF0
#define     SHC_ChannelModeNightSunRiseShift 4
#define SHC_ChannelModeNightSunRiseElevationOffset 12      // uint8_t
...
// Sonne
#define ParamSHC_ChannelModeNightSunRise             ((knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeNightSunRise)) & SHC_ChannelModeNightSunRiseMask) >> SHC_ChannelModeNightSunRiseShift)
// Höhenwinkel Offset
...
// Temperaturgrenze
#define ParamSHC_ChannelModeShading1TemperatureActive ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1TemperatureActive)) & SHC_ChannelModeShading1TemperatureActiveMask))
// Temperaturprognose
#define ParamSHC_ChannelModeShading1TemperatureForecast ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1TemperatureForecast)) & SHC_ChannelModeShading1TemperatureForecastMask))
// Helligkeitlimit
#define ParamSHC_ChannelModeShading1BrightnessActiv  ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1BrightnessActiv)) & SHC_ChannelModeShading1BrightnessActivMask))
// UV-Index
#define ParamSHC_ChannelModeShading1UVIActiv         ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1UVIActiv)) & SHC_ChannelModeShading1UVIActivMask))
// Bei Regen nicht beschatten
#define ParamSHC_ChannelModeShading1RainActiv        ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1RainActiv)) & SHC_ChannelModeShading1RainActivMask))
// Lamellenstellenung an Sonnenstand anpassen
#define ParamSHC_ChannelModeShading1SlatElevationDepending ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1SlatElevationDepending)) & SHC_ChannelModeShading1SlatElevationDependingMask))
// Beschattungsunterbrechung
#define ParamSHC_ChannelModeShading1ShadingBreak     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1ShadingBreak)))
// Beschattungsstart
#define ParamSHC_ChannelModeShading1WaitTimeStart    (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading1WaitTimeStart)))
// Beschattungsende
#define ParamSHC_ChannelModeShading1WaitTimeEnd      (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading1WaitTimeEnd)))
// von
#define ParamSHC_ChannelModeShading1AzimutMin        (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading1AzimutMin)))
// bis
#define ParamSHC_ChannelModeShading1AzimutMax        (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading1AzimutMax)))
// von
#define ParamSHC_ChannelModeShading1ElevationMin     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1ElevationMin)))
// bis
#define ParamSHC_ChannelModeShading1ElevationMax     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1ElevationMax)))
// Mindesttemperatur
#define ParamSHC_ChannelModeShading1TemperatureMin   (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1TemperatureMin)))
// Mindestens prognostizierte Tageshöchsttemperatur
#define ParamSHC_ChannelModeShading1TemperatureForecastMin (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1TemperatureForecastMin)))
// Minimale Hellikeit
#define ParamSHC_ChannelModeShading1BrightnessMin    (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1BrightnessMin)))
// Hellikeit Hysteres
#define ParamSHC_ChannelModeShading1Hysterese        (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading1Hysterese)))
// Minimaler UV-Index
...
#define ParamSHC_ChannelModeShading1RoomTemperaturMinimum (knx.paramFloat(SHC_ParamCalcIndex(SHC_ChannelModeShading1RoomTemperaturMinimum), Float_Enc_IEEE754Single))
// Beschattungsmodus 2
#define ParamSHC_ChannelModeShading2                 ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2)) & SHC_ChannelModeShading2Mask))
// Temperaturgrenze
#define ParamSHC_ChannelModeShading2TemperatureActive ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2TemperatureActive)) & SHC_ChannelModeShading2TemperatureActiveMask))
// Temperaturprognose
#define ParamSHC_ChannelModeShading2TemperatureForecast ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2TemperatureForecast)) & SHC_ChannelModeShading2TemperatureForecastMask))
// Helligkeitlimit
#define ParamSHC_ChannelModeShading2BrightnessActiv  ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2BrightnessActiv)) & SHC_ChannelModeShading2BrightnessActivMask))
// UV-Index
#define ParamSHC_ChannelModeShading2UVIActiv         ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2UVIActiv)) & SHC_ChannelModeShading2UVIActivMask))
// Bei Regen nicht beschatten
#define ParamSHC_ChannelModeShading2RainActiv        ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2RainActiv)) & SHC_ChannelModeShading2RainActivMask))
// Lamellenstellenung an Sonnenstand anpassen
#define ParamSHC_ChannelModeShading2SlatElevationDepending ((bool)(knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2SlatElevationDepending)) & SHC_ChannelModeShading2SlatElevationDependingMask))
// Beschattungsunterbrechung
#define ParamSHC_ChannelModeShading2ShadingBreak     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2ShadingBreak)))
// Beschattungsstart
#define ParamSHC_ChannelModeShading2WaitTimeStart    (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading2WaitTimeStart)))
// Beschattungsende
#define ParamSHC_ChannelModeShading2WaitTimeEnd      (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading2WaitTimeEnd)))
// von
#define ParamSHC_ChannelModeShading2AzimutMin        (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading2AzimutMin)))
// bis
#define ParamSHC_ChannelModeShading2AzimutMax        (knx.paramWord(SHC_ParamCalcIndex(SHC_ChannelModeShading2AzimutMax)))
// von
#define ParamSHC_ChannelModeShading2ElevationMin     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2ElevationMin)))
// bis
#define ParamSHC_ChannelModeShading2ElevationMax     (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2ElevationMax)))
// Mindesttemperatur
#define ParamSHC_ChannelModeShading2TemperatureMin   (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2TemperatureMin)))
// Mindestens prognostizierte Tageshöchsttemperatur
#define ParamSHC_ChannelModeShading2TemperatureForecastMin (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2TemperatureForecastMin)))
// Minimale Hellikeit
#define ParamSHC_ChannelModeShading2BrightnessMin    (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2BrightnessMin)))
// Hellikeit Hysteres
#define ParamSHC_ChannelModeShading2Hysterese        (knx.paramByte(SHC_ParamCalcIndex(SHC_ChannelModeShading2Hysterese)))
// Minimaler UV-Index
...
#define SHC_KoCHManuelStopStart 12
#define SHC_KoCHManuelActiv 13
#define SHC_KoCHManualLock 14
#define SHC_KoCHManualLockActive 15
#define SHC_KoCHManualUpDown 16
...
// 
#define KoSHC_CHShadingControlActive              (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHShadingControlActive)))
// 
#define KoSHC_CHShadingActive                     (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHShadingActive)))
// 
#define KoSHC_CHLock                              (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHLock)))
// 
#define KoSHC_CHLockActive                        (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHLockActive)))
// 
#define KoSHC_CHActiveMode                        (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHActiveMode)))
// 
#define KoSHC_CHManuelStopStart                   (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManuelStopStart)))
// 
#define KoSHC_CHManuelActiv                       (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManuelActiv)))
// 
#define KoSHC_CHManualLock                        (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManualLock)))
// 
#define KoSHC_CHManualLockActive                  (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManualLockActive)))
// 
#define KoSHC_CHManualUpDown                      (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManualUpDown)))
// 
#define KoSHC_CHManualStepStop                    (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManualStepStop)))
// 
#define KoSHC_CHManualPercent                     (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHManualPercent)))
// 
...
// 
#define KoSHC_CHModeNightLock                     (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeNightLock)))
// 
#define KoSHC_CHModeNightLockActive               (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeNightLockActive)))
...
// 
#define KoSHC_CHModeShading1Lock                  (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading1Lock)))
// 
#define KoSHC_CHModeShading1LockActive            (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading1LockActive)))
// 
#define KoSHC_CHModeShading1ShadingBreakLock      (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading1ShadingBreakLock)))
// 
#define KoSHC_CHModeShading1ShadingBreakLockActive (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading1ShadingBreakLockActive)))
// 
#define KoSHC_CHModeShading2Active                (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading2Active)))
// 
#define KoSHC_CHModeShading2Lock                  (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading2Lock)))
// 
#define KoSHC_CHModeShading2LockActive            (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading2LockActive)))
// 
#define KoSHC_CHModeShading2ShadingBreakLock      (knx.getGroupObject(SHC_KoCalcNumber(SHC_KoCHModeShading2ShadingBreakLock)))
// 
